...
<head>
    <meta charset="utf-8">
    <title>Container Approved for Loading</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        <h2 style="color: #059669;">Container Approved - Ready for Loading</h2>

        <p>Dear Team,</p>

        <p>The container has been approved by management and is now ready for loading operations.</p>
        ...
        <p>You can now upload the required loading photos and documentation.</p>

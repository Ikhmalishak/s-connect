        ...
        <div class="max-w-full mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="flex border-b sticky top-0 bg-white z-10">
                    <div class="w-24 flex-shrink-0 border-r bg-gray-50"></div>
                    <div
                        v-for="room in rooms"
                        :key="room.id"
                        class="flex-1 min-w-[180px] p-4 border-r last:border-r-0"
                    >
                        <div
                            class="w-full h-24 bg-gradient-to-br from-indigo-400 to-purple-500 rounded-lg mb-2 flex items-center justify-center"
                        >
                            <svg
                ...
                <div class="flex overflow-auto">
                    <!-- Time labels -->
                    <div class="w-24 flex-shrink-0 border-r bg-gray-50">
                        <div
                            v-for="time in timeSlots"
                            :key="time"
                            class="h-[60px] flex items-start justify-end pr-3 pt-2 text-sm font-medium text-gray-600 border-t first:border-t-0"
                        >
                            {{ time }}
                        </div>
                    </div>
                    ...
                    <div class="flex flex-1">
                        <div
                            v-for="room in rooms"
                            :key="room.id"
                            class="flex-1 min-w-[180px] relative border-r last:border-r-0"
                        >
                            <!-- Time slot grid lines -->
                            <div
                                v-for="time in timeSlots"
                                :key="time"
                                class="h-[60px] border-t first:border-t-0 hover:bg-gray-50 transition-colors"
                            ></div>
...
<div class="overflow-x-auto">
  ...
  >
    <!-- Sticky Header Row -->
    <div class="sticky top-0 z-20 bg-white border-b"></div>
    <div
      v-for="room in rooms"
      :key="room.id"
    ...
    >
      ...
      >
        <div class="text-sm font-semibold whitespace-nowrap">{{ booking.title }}</div>
        <div class="text-xs">
